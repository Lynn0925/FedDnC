...
from .trainers.feddnc_learner import FedDnCLearner
from .trainers.local_coop_learner import LocalCoOpLearner
...
class FederatedLearnerFactory:
    ...
    _learner_registry = {
        ...
        'FedDnC': FedDnCLearner,
        'LocalCoOp': LocalCoOpLearner,
    }
