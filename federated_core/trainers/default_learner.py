# federated_core/trainers/default_learner.py
...
class DefaultLearner(BaseFederatedLearner):
    """Default implementation for FedAvg, FedProx, Local algorithms."""
    ...
    def update_client_models(self, client_ids: List[int],
        ...
        for client_id in all_clients:
            ...
            print(f"Client {client_id} update completed")
