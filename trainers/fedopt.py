...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.FEDOPT.N_CTX
        ctx_init = cfg.TRAINER.FEDOPT.CTX_INIT
        dtype = clip_model.dtype
        ctx_dim = clip_model.ln_final.weight.shape[0]
        clip_imsize = clip_model.visual.input_resolution
        cfg_imsize = cfg.INPUT.SIZE[0]
        self.N = cfg.TRAINER.FEDOPT.N
        ...
        self.class_token_position = cfg.TRAINER.FEDOPT.CLASS_TOKEN_POSITION
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.eps = cfg.TRAINER.FEDOPT.EPS
        self.max_iter = 100
        self.thresh = cfg.TRAINER.FEDOPT.THRESH
        self.OT = cfg.TRAINER.FEDOPT.OT
        self.top_percent = cfg.TRAINER.FEDOPT.TOP_PERCENT
        self.max_iter = cfg.TRAINER.FEDOPT.MAX_ITER
...
class FedOPT(TrainerX):
    """
    It is based on CoOp.
    """

    def check_cfg(self, cfg):
        assert cfg.TRAINER.FEDOPT.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.FEDOPT.PREC == "fp32" or cfg.TRAINER.FEDOPT.PREC == "amp":
        ...
        self.scaler = GradScaler() if cfg.TRAINER.FEDOPT.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.FEDOPT.PREC
        if prec == "amp":
            with autocast('cuda'):
