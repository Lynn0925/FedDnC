#!/bin/bash
# LODO on Office-Caltech10 with FedOPT
# Usage: bash scripts/FedOPT/office_lodo.sh <GPU> [SEED]
...
for TARGET in "${DOMAINS[@]}"; do
    ...
    echo "============================================"
    echo "[MaPLe] Target domain: ${TARGET}"
    echo "Output: ${DIR}"
    echo "============================================"
...
echo "All FedOPT Office-Caltech10 LODO runs completed."
