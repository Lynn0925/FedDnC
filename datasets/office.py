...
from data_utils import prepare_data_office, prepare_data_office_lodo, prepare_data_office_partition_train
...
class Office():
    ...
    def __init__(self, cfg):
        ...
        if target_domain:
            exp_folder = 'fed_office_lodo'
            print(f"LODO mode: target={target_domain}")
            train_set, test_set, classnames, lab2cname = prepare_data_office_lodo(cfg, root)
