...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        # 尝试获取 test_loader，如果不存在则设为 None
        self.test_loader = getattr(dm, "test_loader", None)

        # 如果你的联邦评估需要用到 federated_test_loader，也可以在这里挂载
        self.federated_test_loader = getattr(dm, "federated_test_loader", None)
